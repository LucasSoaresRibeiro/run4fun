            ...
            <html lang='pt-BR'> <!-- Adjusted language -->
                <head>
                    ...
                    <style>
                        ...
                        .close-link { display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #aa3365; color: white; text-decoration: none; border-radius: 5px; cursor: pointer; }
